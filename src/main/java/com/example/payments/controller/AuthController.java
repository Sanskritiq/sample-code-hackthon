...
public class AuthController {
    ...
    public ResponseEntity<String> nullPointerTest(@RequestBody Map<String, Object> payload) {
        ...
        if (testValue == null) {
            logger.warn("Received /login request with 'key' as null or missing in payload: {}", payload);
            return ResponseEntity.badRequest().body("Error: 'key' is a required field and cannot be null.");
        }
